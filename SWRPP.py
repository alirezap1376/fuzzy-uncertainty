...
DevisionSirstConstraint =DevisionSirstConstraint = sum(demand[k1][3] - (1-model.a)*demand[k1][2] - model.a * demand[k1][3] for k1 in k)




model.obj=py.Objective(expr=  Zmax + Sigma*(DevisionSirstConstraint) , sense = 1 )
